...
Parallelization notes: 03/04/05 are a strict chain; 07 and 08 are independent of each other; 08 can be built any time after 02; 11 is strictly last within the port. Post-port plans 12/13 are independent of each other; 14 needs 11. Everything else respects the numeric order.
...
- All eleven port plans (01–11) landed; `plans/` updated with any deviations. (Plans 12–14 are post-port improvements — tracked here, but they do not gate the port.)
