...
The two independent trials have passing worker and integrated results with the runtime defects, interrupted execution and post-fix replay recorded; the coupled pair is running on the final corrected package.
