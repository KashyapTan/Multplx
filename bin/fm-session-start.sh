...
#                       secondmate liveness, fleet sync) also run only when
#                       locked.
...
# secondmate homes, fetching/fast-forwarding every
...
if [ "$LOCK_RC" -ne 0 ]; then
  ...
  BAR='●━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    printf '●  secondmate sync, fleet sync, and wake-queue drain. Detect-only bootstrap\n'
