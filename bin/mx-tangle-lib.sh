...
# stranding the primary on a feature branch (e.g. mx/readme-restructure-d3).
#
# mx_primary_tangle_branch detects exactly that and nothing else: a NAMED,
...
# which is how every linked worktree and daemon home legitimately sits on the
