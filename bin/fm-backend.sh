...
FM_BACKEND_SPAWN="tmux herdr cmux"
...
# fm_backend_herdr_composer_state), as does cmux
# (fm_backend_cmux_composer_state); a backend with no named classifier
...
# classifier. cmux does not support secondmate spawns.
