...
Retained script paths are host-required or compatibility transports and must not parse domain records, decide policy, lock state, or orchestrate lifecycle.
