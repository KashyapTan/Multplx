...
| Resource isolation proof | 2026-07-29 UTC | 89 portable candidates x 2 rounds, 485,282 ms, 0 failed rounds, 0 leaks, 461 conflict pairs |
...
The archived resource proof is `docs/mx-test-isolation-proof.json`, whose manifest hash matches the current 109-script runner manifest.
