...
| Resource isolation proof | 2026-07-30 UTC | 90 portable candidates x 2 rounds, 518,761 ms, 0 failed rounds, 0 leaks, 464 conflict pairs |
...
The archived resource proof is `docs/mx-test-isolation-proof.json`, whose manifest hash matches the current 110-script runner manifest.
